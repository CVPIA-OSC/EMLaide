...
#' Creative Commons
#' @examples 
#' add_license(parent_element = list(), default_license = "CCO")
#' 
#' add_license(parent_element = list(), default_license = "CCBY")
#' 
#' add_license(parent_element = list(), default_license = NULL, 
#' license_name = "MIT", license_url = "http://", license_identifier = "MIT", intellectual_rights_descripiton = "")
#' 
#' @export
add_license <- function(parent_element, license_name = NULL, license_url = NULL, license_identifier = NULL,
