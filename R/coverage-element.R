...
#' chinook <- add_taxonomic_coverage(CVPIA_common_species = EDIutils::CVPIA_common_species$chinook)
#' delta <- add_taxonomic_coverage(CVPIA_common_species = EDIutils::CVPIA_common_species$delta_smelt)
