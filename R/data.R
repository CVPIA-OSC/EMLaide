...
#'   point, which allows the ratio to have meaning. For example measurment heights, 
...
#'   between those points). The most encompassing format is: YYYY-MM-DDThh:mm:ss. ?measu
#' 
#' @examples
...
#' @param steelhead
#' @param delta_smelt 
#' @param white_sturgeon 
#' @param green_sturgeon
#' @examples 
