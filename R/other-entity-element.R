...
#'
#' @export            
create_other_entity <- function(file_name, file_description, file_type) {
  
  required_arguments <- c("file_name", "file_description", "file_type")
  
  missing_argument_index <- which(c(missing(file_name), missing(file_description), missing(file_type)))
