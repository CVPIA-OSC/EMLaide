...
dataset_files <- dplyr::tibble(datatable = c(system.file("extdata", "Hannon-Example",
                                             ...
                                             system.file("extdata", "Hannon-Example",
                                                        ...
                                                        package = "EMLaide", mustWork = TRUE)),
                               datatable_name = c("snorkel-index-data-2015-2020.csv",
                                                  "hannon_example_physical_data.csv"),
...
```{r, eval = FALSE}
dataset_files <- dplyr::tibble(datatable = c("extdata/Hannon-Example/snorkel-index-data-2015-2020.csv",
                                            "extdata/Hannon-Example/hannon_example_physical_data.csv"),
                               datatable_name = c("snorkel-index-data-2015-2020.csv", 
                                                  "hannon_example_physical_data.csv"),
                               attribute_info = c("extdata/Hannon-Example/snorkel-index-metadata.xlsx",
                                                  "extdata/Hannon-Example/example-metadata.xlsx")
...
```{r, eval = FALSE}
# TODO add real example for spatialRaster
