...
## Multiple datasets are loaded in here and the attribute sheets for each dataset are collected in a named list 
dataset_file <- list("snorkel data" = "hannon", "predator data" = "hello")

atrribute_metadata <- list("snorkel data metadata" = "path", "predator data metadata" = "path")
...
```{r}
# Each dataset has an individual attribute sheet to describe the attributes of that dataset.
...
```{r}
parent_element$dataTable <- list(entityName = dataset_file,
