...
[initial metadata information](Initial-Metadata-Information.Rmd).
...
to your file. If you are not adding a CC0 or CCBY default license please see [initial metadata information](Initial-Metadata-Information.Rmd) This information can be added to the 
...
must contain a project title, a project personnel, and project funding. For more detailed 
information on the project section of the EML please visit the [project specific instructions](Project-Element.Rmd).
...
instructions on appending multiple datatables please see the [dataset specific instructions](Dataset-Element.Rmd).
...
code definition), you must also fill out the tab "code_definitions". Give the `attribute_name` and the 
unique code and definition for every attribute that is "enumerated". Every single 
...
[detailed dataset instructions](Dataset-Element.Rmd). 
