...
# purrr::pmap(keyword_set$keywordThesaurus, function(){
#   keywords <- keyword_set$keyword[]
# })
...
adds_project_person <- function(first_name, last_name, email, role, organization, orcid) {
  project_personnel <- add_personnel(list(), first_name, last_name, email,
                                  role, organization, orcid)
...
add_a_funder <- function(funder_name, funder_identifier, award_number, award_title, 
  ...
  parent_element <- add_funding(funder_name, funder_identifier, award_number, award_title,
                                award_url, funding_description)
}
parent_element <- purrr::pmap(metadata$funding, add_a_funder)
```
...
```{r}
parent_element <- add_project(parent_element, project_title, award_information,
                              project_personnel)
``` 
