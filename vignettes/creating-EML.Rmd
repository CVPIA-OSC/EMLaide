...
It is also possible to use the EMLaide function `api_create_reservation()` to generate a EDI number using R. See the `api_create_reservation()` [documentation.](https://ediorg.github.io/EMLaide/reference/api_create_reservation.html)
```{r}
...
If you feel ready to upload your document to the EDI data repository you can do that from R using the Environmental Data Initiatives EMLaide package. Use the `api_create_data_package()` to create the initial version of a data package. 
